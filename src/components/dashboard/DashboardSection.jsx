...
export function DashboardSection() {
  return (
    <div className="lg:flex lg:items-center lg:justify-between w-full bg-indigo-100/5 px-7 py-5 rounded-lg">
      ...
      <div className="mt-5 flex lg:mt-0 lg:ml-4">
        <span className="hidden sm:block">
          <button
            type="button"
            className="inline-flex items-center rounded-md border border-transparent bg-indigo-300/10 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-200/10 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800"
          >
