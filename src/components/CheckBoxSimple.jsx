...
export function CheckBoxSimple({index=0, name, isChecked , callback}){
    ...
    return (
        <label for={rId} className={`${isChecked && 'border-indigo-500 ring-1 ring-offset-0 ring-indigo-500'} w-full max-w-[90px] h-[49px] mr-3 mt-2 relative flex border-gray-500 items-center cursor-pointer rounded-lg border hover:shadow bg-black/20 p-4 shadow-sm focus:outline-none`}>
